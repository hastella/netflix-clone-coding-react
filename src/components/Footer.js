...
const Footer = () => {
  return (
    <footer>
        <section className="footer_column_list">
            <div className="col-4">
                <a className="btn btn-footer btn-outline-light btn-floating m-1" href="https://www.facebook.com/NetflixKR" role="button">
        ...
        <section className="footer_info">
            <button className="footer_info_btn btn btn-secondary">
                서비스 코드
            </button>
            <div className="info">
                <div>
